# Churn model card — `20260905T010415Z`

- **Created:** 2026-09-05T01:04:15+00:00
...
Tuned to **0.24** (maximises churn recall at precision >= 0.5 (out-of-fold)).
...
| --- | --- | --- | --- | --- |
| tuned (0.24) | 0.492 | 0.818 | 0.614 | 0.727 |
